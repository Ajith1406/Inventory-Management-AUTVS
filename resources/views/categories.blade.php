                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                            <div class="case-item">
                                                <div class="case-item__thumb">
                                                    <img src="{{$category->picture}}" alt="{{$category->category_name}}">
                                                </div>
                                                <h6 class="case-item__title"><a href="{{route('public.category.items',['id'=>$category->id])}}">{{$category->category_name}}</a></h6>
                                            </div>
                                        </div>
                                        @endforeach
                                    <div>
